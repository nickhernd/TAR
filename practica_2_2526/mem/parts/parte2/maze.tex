...
El robot \textbf{no es capaz} de resolver el laberinto 2 con el algoritmo
de seguimiento de pared izquierda. Como ya se ha dicho en la parte anterior se observa que la topología es distinta al primer ejercicio por lo cual la estrategia debería de ser diferente, se ha pensado en añadir a la máquina de estados un nuevo de estados en lo que implicaria un contador cada cierto número de giros a la izquierda seguidos en un periodo de tiempo corto cambiar de rumbo.
