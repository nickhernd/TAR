...
: ${AMENT_CURRENT_PREFIX:="/workspace/ros2_ws/install/parte2"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/parte2/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/parte2/environment/path.sh"
