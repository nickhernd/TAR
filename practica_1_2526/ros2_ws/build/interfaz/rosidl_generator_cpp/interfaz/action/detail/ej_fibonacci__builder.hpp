...
class Init_EjFibonacci_Feedback_feedback_value
{
public:
  Init_EjFibonacci_Feedback_feedback_value()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::interfaz::action::EjFibonacci_Feedback feedback_value(::interfaz::action::EjFibonacci_Feedback::_feedback_value_type arg)
  {
    msg_.feedback_value = std::move(arg);
    return std::move(msg_);
  }
...
{
  return interfaz::action::builder::Init_EjFibonacci_Feedback_feedback_value();
}
