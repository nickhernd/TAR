...
struct EjFibonacci_Feedback_
{
  ...
  // field types and members
  using _feedback_value_type =
    double;
  _feedback_value_type feedback_value;

  // setters for named parameter idiom
  Type & set__feedback_value(
    const double & _arg)
  {
    this->feedback_value = _arg;
    return *this;
  }
  ...
  {
    if (this->feedback_value != other.feedback_value) {
      return false;
    }
    return true;
  }
